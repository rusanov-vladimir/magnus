namespace Client.Views
{
	...
	public partial class SpinProgressView
	{

		private readonly DispatcherTimer _animationTimer;

		public SpinProgressView()
		{
			InitializeComponent();
			_animationTimer = new DispatcherTimer(DispatcherPriority.Normal, Dispatcher) { Interval = new TimeSpan(0, 0, 0, 0, 125) };
		}
